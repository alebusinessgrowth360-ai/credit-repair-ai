...
3. Extrae TODOS los hard inquiries con estos campos exactos: empresa (nombre de la empresa que hizo el inquiry), fecha (MM/YYYY), buro (TransUnion, Equifax, o Experian), tipo ("hard"). TODOS los inquiries deben tener buro asignado.
